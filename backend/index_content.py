"""
Script to index the humanoid robots book content into the Qdrant vector database.
"""
import os
import sys
import glob
...
def read_content_files(content_directory: str) -> list:
    """
...
def main():
    ...
    content_files = read_content_files(content_directory)
